...
Crucible::D3D12Renderer::~D3D12Renderer()
{
}
int32_t Crucible::D3D12Renderer::CreateMesh()
{
   return 0;
}
int32_t Crucible::D3D12Renderer::CreateTexture()
{
   return 0;
}
int32_t Crucible::D3D12Renderer::CreatePiplelineState()
{
   return 0;
}
int32_t Crucible::D3D12Renderer::CreateConstantBuffer()
{
   return 0;
}
void Crucible::D3D12Renderer::ReleaseResource(int32_t handle)
{
}
void Crucible::D3D12Renderer::Worker(int32_t workerIndex)
{
}
#endif